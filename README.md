...
- UI/UX redesign pass added: unauthenticated users land on Login first, authenticated tabs are simplified to Dashboard, Cards, Pay, Activity, and Wallet, dashboard/card/profile/onboarding screens use cleaner fintech-style layouts, and shared components now support light/dark theme colors.
